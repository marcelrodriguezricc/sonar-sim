...
plt.xlabel('X')
plt.ylabel('Y')
plt.savefig('/Users/marcel/Desktop/sonar-sim/docs/figures/bathymetry-2d.png', dpi=300)
plt.show()
...
plt.savefig('/Users/marcel/Desktop/sonar-sim/docs/figures/bathymetry-3d.png', dpi=300)
plt.show()